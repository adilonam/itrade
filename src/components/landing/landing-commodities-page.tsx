...
type LandingCommoditiesPageProps = {
  appName: string;
  session: boolean;
};

export async function LandingCommoditiesPage({
  appName,
  session
}: LandingCommoditiesPageProps) {
    ...
    >
      ...
      <section className='pt-28 pb-20 md:pt-36 md:pb-24'>
        <div className='mx-auto w-full max-w-[1060px] px-5 md:px-16'>
          ...
          <h1
            className={`${ebGaramond.className} mb-8 text-[44px] leading-[1.1] text-black md:text-[64px]`}
          >
            {t('title')}
          </h1>

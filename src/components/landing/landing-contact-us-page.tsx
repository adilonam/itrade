...
export async function LandingContactUsPage({
  appName,
  session
}: LandingContactUsPageProps) {
        ...
        <div className='mx-auto w-full max-w-[1060px] px-5 md:px-16'>
          ...
          <article className='rounded-2xl border border-[#d0d2d2] bg-white p-7 shadow-[0_12px_36px_rgba(0,0,0,0.06)] md:p-10'>
            <div className='mb-6 flex items-center gap-3 text-[#222526]'>
              ...
              <p className='text-[22px] leading-tight font-medium md:text-[28px]'>
                Support
              </p>
            </div>
            ...
            <p className='mt-5 text-sm leading-6 text-[#525758]'>
              {content.note}
            </p>
          </article>
        </div>

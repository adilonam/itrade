...
export function LandingFlagIcon({ country, className = 'h-4 w-6 rounded-sm' }: LandingFlagIconProps) {
  switch (country) {
    case 'gb':
      return (
    ...
    case 'sa':
      return (
        <svg className={className} viewBox="0 0 60 40" aria-hidden>
          ...
          <text x="30" y="26" fill="#fff" fontSize="10" textAnchor="middle" fontFamily="serif">
            ☪
          </text>
        </svg>
      );
    ...
    case 'pt':
      return (
        <svg className={className} viewBox="0 0 60 40" aria-hidden>
          ...
          <circle cx="24" cy="20" r="7" fill="#FF0000" stroke="#FFD700" strokeWidth="1" />
        </svg>
      );
    default:
      return (

...
import { UserPositionsTableRoomStock } from './user-positions-table-room-stock';
import type {
  Position,
  PositionType,
  PositionStatus,
...
export function UserPositionsViewRoomStock() {
  ...
  // Load positions
  const loadPositions = async (page = 1, newFilters: PositionFilters = {}) => {
    try {
      setLoading(true);
      setError(null);
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Filter your positions by various criteria
          </CardDescription>
        </CardHeader>
        <CardContent>

...
export function UserTransactionsViewRoomTrading() {
    ...
    <div className='space-y-6'>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>
              Total Room Trading Transactions
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Filter your room trading transactions by various criteria
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className='flex items-center justify-between'>
        <div className='text-muted-foreground text-sm'>
          Showing {transactions.length} of {pagination.total} room trading
          transactions
        </div>
      </div>
      ...
      {/* Transactions Table */}
      <UserTransactionsTableRoomTrading

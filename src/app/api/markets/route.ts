 ...
 *     description: Retrieves visible markets from the database filtered by room type. Supports STOCK, TRADING, or ALL rooms.
 *     tags:
 *       - Markets
 *     parameters:
 *       - in: query
 ...
 *                 message:
 *                   type: string
 *                   example: "Room must be one of: STOCK, TRADING, ALL"
 *       500:
